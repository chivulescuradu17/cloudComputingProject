...
var uiCustomSelect = (function() {
    ...
    function init(elem){
        ...
        var customSelect = elem ? [elem] : document.getElementsByClassName('js-select');
...
uiCustomSelect.init(eSelect.parentNode)

const ySelect = document.getElementById('ySelect');
uiCustomSelect.init(ySelect.parentNode)